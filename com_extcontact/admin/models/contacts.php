 ...
 */
class ExtcontactModelContacts extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from('#__extcontact_details AS a');
		...
		if ($assoc)
		{
			...
			->join('LEFT', '#__associations AS asso ON asso.id = a.id AND asso.context=' . $db->quote('com_extcontact.item'))
		...
		if (is_numeric($tagId))
		{
			...
			->join(
					...
					. ' AND ' . $db->quoteName('tagmap.type_alias') . ' = ' . $db->quote('com_extcontact.contact')
			);
		}
