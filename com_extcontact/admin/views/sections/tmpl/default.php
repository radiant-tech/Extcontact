...
?>
<form action="<?php echo JRoute::_('index.php?option=com_extcontact&view=sections'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							...
							JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'sections');
