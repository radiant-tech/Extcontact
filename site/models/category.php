...
/**
 * Category Model for Extcontact component
 */
class ExtcontactModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	/**
	 * The list of other extcontact categories.
	 *
	 * @access    protected
	 * @var        array
	 */
	...
	protected function getListQuery()
	{
		...
		->from($db->quoteName('#__extcontact_details') . ' AS a')
	...
	public function getCategory()
	{
		if (!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Extcontact', $options);
