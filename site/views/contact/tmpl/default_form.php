...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			<legend><?php echo JText::_('COM_EXTCONTACT_FORM_LABEL'); ?></legend>
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
							...
							<?php else:?>
								<div class="control-label">
									...
									<?php if (!$field->required && $field->type != "Spacer") : ?>
										<span class="optional"><?php echo JText::_('COM_EXTCONTACT_OPTIONAL');?></span>
									<?php endif; ?>
								</div>
				...
				<?php endif ?>
			<?php endforeach;?>
			<div class="form-actions"><button class="btn btn-primary validate" type="submit"><?php echo JText::_('COM_EXTCONTACT_CONTACT_SEND'); ?></button>
				<input type="hidden" name="option" value="com_extcontact" />
